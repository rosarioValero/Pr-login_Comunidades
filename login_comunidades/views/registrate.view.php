...
<body>
    ...
    <hr class= "border">
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="formulario" name="login">
            ...
            <div class="form-group">
                <i class="icono izquierda fas fa-envelope-square"></i><input type="text" name="email" class="email" placeholder="Email">
            </div>
            <div class="form-group">
                <i class="icono izquierda fas fa-user"></i><input type="text" name="nombre" class="nombre" placeholder="Nombre">
            </div>
            <div class="form-group">
